...
class _RegisterScreenState extends State<RegisterScreen> {
      ...
      builder: (context) => AlertDialog(
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              const Text(
                'Important: Save this recovery code in a safe place. If you lose your password, this code can be used to recover your account.',
                style: TextStyle(
              ...
              const Text(
                'If you lose your password, ALL your encrypted data becomes inaccessible. There is no password reset mechanism for security reasons.',
                style: TextStyle(
                  color: AppColors.textSecondary,
                  fontSize: 12,
                ),
  ...
  String _generateRecoveryCode() {
    // This would be generated by AuthService.register() in real implementation
    // For now, show a placeholder
    return 'REC-' +
        List.generate(4, (_) => List.generate(4, (_) => '0123456789ABCDEF'.split('')[DateTime.now().microsecond % 16]).join('-')).join('-');
  }
