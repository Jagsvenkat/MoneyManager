...
class EnvelopeEncryption {
  ...
  static Future<EncryptionEnvelope> encrypt({
    ...
    final encDekWithNonce = Uint8List(encryptedDek.length + wrappingNonce.length)
      ..setRange(0, wrappingNonce.length, wrappingNonce)
      ..setRange(wrappingNonce.length, wrappingNonce.length + encryptedDek.length, encryptedDek);
