...
1. Create auth UI screens (login/signup)
2. Build dashboard with charts
3. Implement expenses table with filters
...
3. **Implementation Questions**: See `IMPLEMENTATION_STATUS.md`
4. **Code Examples**: Review `test/` directory
5. **Commit History**: See `GIT_COMMIT_GUIDE.md`
